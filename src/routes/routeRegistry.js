...
const DuplicateDetection = lazy(() => import("../pages/hospital/DuplicateDetection"));
...
export const ROUTES = [
  ...
  { page: "duplicates", slugs: ["duplicates", "duplicate-reconciliation"], component: DuplicateDetection, access: HOSPITAL_ONLY },
